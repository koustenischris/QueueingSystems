...
first = find(lambda == 10); # finds the row number where lambda == 10
second = find(lambda == 50); # finds the row number where lambda == 50
...
legend(sprintf("n = %d and p = %f",n(1),p(1)),sprintf("n = %d and p = %f",n(2),p(2)),sprintf("n = %d and p = %f",n(3),p(3)),sprintf("n = %d and p = %f",n(4),p(4)),sprintf("n = %d and p = %f",n(5),p(5)));
hold off;
