...
title("Average number of clients in the M/M/1/10 queue: Convergence with λ=5 clients/min");
...
bar(state,P,'r',0.4);
title("Probabilities of each of the 11 states λ=5 clients/min");
